...
class LPIPS(nn.Module):
    ...
    def __init__(self, ckpt_path, use_dropout=True):
        super().__init__()
...
class vgg16(torch.nn.Module):
    ...
    def forward(self, X):
        ...
        h = self.slice1(X)
        h_relu1_2 = h
        # print('h_relu1_2', h.shape)
        h = self.slice2(h)
        h_relu2_2 = h
        # print('h_relu2_2', h.shape)
        h = self.slice3(h)
        h_relu3_3 = h
        # print('h_relu3_3', h.shape)
        h = self.slice4(h)
        h_relu4_3 = h
        # print('h_relu4_3', h.shape)
        h = self.slice5(h)
        h_relu5_3 = h
        # print('h_relu5_3', h.shape)
